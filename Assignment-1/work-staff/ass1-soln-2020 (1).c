...
/* This program is provided as an example of what you should be
   aspiring to create in a comp20005 or comp10002 assignment.

   It uses structs to build the required data, but you assignment 
   may not require their use, and anything that can be done with structs
   can sloe be done with parallel arrays, one array for each component.

   Read your actual assignment specification carefully, to see if structs
   are required, or merely optional.
*/
